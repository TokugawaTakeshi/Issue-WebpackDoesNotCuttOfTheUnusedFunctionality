const GetRandomStringOperationLocalization__English = {
    errors: {
        minimalSymbolsCountMustBeGreaterThan0: (realValue) => `The 'minimalSymbolsCount' property must be greater than 0 while really it's ${realValue}`,
        sumOfSymbolsCountOfAffixesAndMinimalRandomlyGeneratedSymbolsCountIsExceedsMaximalSymbolsCount: (parametersObject) => "The sum of symbols count of 'prefix', 'infix' and 'postfix' and also 'minimalRandomlyGeneratedSymbolsCount' are " +
            ...
            `                            SUBTOTAL: ${parametersObject.prefix.length +
        ...
        explicitlySpecifiedMinimalSymbolsCountExceedsMaximalSymbolsCount: ({ minimalSymbolsCount, maximalSymbolsCount }) => `The explicitly specified minimal symbols count (${minimalSymbolsCount}) exceeds the maximal symbols ` +
